  ...
  <div class='col-md-12'>
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Edit Principals here</h3>
      ...
      <div class="box-body table-responsive no-padding">
        ...
        <div class="col-md-12">
          ...
          {!!Form::model($principals,array('route' => array('vidyaaarambha.masters.principals.update', $principals->id), 'method' => 'PUT','files'=>true,'id'=>'edit-form','onsubmit'=>'return validate()'))!!}
          {!!Form::hidden('id',$principals->id)!!}
        ...
        <div class="col-md-12" style="margin-top: 10px;">
         <div class="col-md-8" id="details_div">
           @if($principals->image)
           <?php $attachment_path = getPrincipalsUploadedPath($principals->image)?>
     ...
     <div class="col-md-2 pull-right">
      <a href="{{URL::route('vidyaaarambha.masters.principals.index')}}">{!! Form::button('Cancel', ['class' => 'btn btn-block btn-danger btn-block','id'=>'clr-btn']) !!}</a>
    </div>
    <div class="col-md-2 pull-right">
...
<script type="text/javascript">
  ...
  $('#description').val(principals['description']);
  ...
  $('#upload_btn').click(function(){
    ...
    var ajax = $.ajax({
      type: 'post',
      url:'{{URL::route("vidyaaarambha.masters.principals.uploadPrincipalsImg")}}',
