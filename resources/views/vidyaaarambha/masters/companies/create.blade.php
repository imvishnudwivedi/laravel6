  ...
  <div class='col-md-12'>
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Add Companies here</h3>
      ...
      <div class="box-body table-responsive no-padding">
        ...
        <div class="col-md-12">
          {!!Form::open(array('route' => array('vidyaaarambha.masters.companies.store'), 'method' => 'POST','files'=>true,'id'=>'add-form','onsubmit'=>'return validate()'))!!}
