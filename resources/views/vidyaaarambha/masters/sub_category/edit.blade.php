    ...
    <div class="box box-primary">
      ...
      <div class="box-body table-responsive no-padding">
        ...
        <div class="col-md-12">
         ...
         {!!Form::model($sub_category,array('route' => array('vidyaaarambha.masters.sub_category.update', $sub_category->id), 'method' => 'PUT','files'=>true,'id'=>'edit-form','onSubmit'=>'return validate()'))!!}
...
console.log(11111111);
  ...
  var ajax = $.ajax({
    type: 'post',
    url:'{{URL::route("vidyaaarambha.masters.sub_category.uploadSubCategoryImage")}}',
