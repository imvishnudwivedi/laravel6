...
<!-- Mirrored from rometheme.net/html/kids/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 12:11:27 GMT -->
...
<li class="nav-item">
			                    <a class="nav-link" href="page-events-single.html">ADMISSION</a>
			                </li>
...
<div class="item">
	            <img src="images/slider5.jpg" alt="Slider"> 
	            <div class="overlay-bg"></div>
	            <div class="container d-flex align-items-center">
	            	<div class="wrap-caption">
		                <h4 class="caption-supheading">Welcome to Kids</h4>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-6">
						<img src="images/welcome.jpg" alt="" class="img-fluid img-border mb-3">
					</div>
					<div class="col-sm-12 col-md-12 col-lg-6">
	...
	<!-- FUNFACT -->
	<div class="section bgi-overlay bgi-cover-center" data-background="images/middlebcbanner.jpg">
		<div class="content-wrap">
			<div class="container">
				<div class="row">
					<!-- Item 1 -->
				...
				<div class="row mt-4">
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="rs-class-box mb-5">
							<div class="media-box">
								<img src="images/class1.png" alt="" class="img-fluid">
							</div>
							<div class="body-box">
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="rs-class-box mb-5">
							<div class="media-box">
								<img src="images/class3.png" alt="" class="img-fluid">
							</div>
							<div class="body-box">
								<div class="class-name">
			...
			<div class="container">
				<div class="row align-items-end">
					...
					<div class="col-sm-12 col-md-12 col-lg-5">
						<img src="images/singleimg1.png" alt="" class="img-fluid">
					</div>
				</div>
				...
				<div class="row popup-gallery gutter-5">
					...
					<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal6.jpg" title="Gallery #1">
					...
					<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal7.jpg" title="Gallery #2">
								<img src="images/gal7.jpg" alt="" class="img-fluid">
								<div class="project-info">
									<div class="project-icon">
										<span class="fa fa-search"></span>
									</div>
					...
					<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal8.jpg" title="Gallery #3">
								<img src="images/gal8.jpg" alt="" class="img-fluid">
								<div class="project-info">
									<div class="project-icon">
										<span class="fa fa-search"></span>
									</div>
					...
					<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal9.jpg" title="Gallery #4">
								<img src="images/gal9.jpg" alt="" class="img-fluid">
								<div class="project-info">
									<div class="project-icon">
										<span class="fa fa-search"></span>
									</div>
					...
					<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal10.jpg" title="Gallery #5">
								<img src="images/gal10.jpg" alt="" class="img-fluid">
								<div class="project-info">
									<div class="project-icon">
										<span class="fa fa-search"></span>
									</div>
					...
					<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal11.jpg" title="Gallery #6">
								<img src="images/gal11.jpg" alt="" class="img-fluid">
								<div class="project-info">
									<div class="project-icon">
										<span class="fa fa-search"></span>
									</div>
...
<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal12.jpg" title="Gallery #6">
								<img src="images/gal12.jpg" alt="" class="img-fluid">
								<div class="project-info">
									<div class="project-icon">
										<span class="fa fa-search"></span>
									</div>
...
<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal13.jpg" title="Gallery #6">
								<img src="images/gal13.jpg" alt="" class="img-fluid">
								<div class="project-info">
									<div class="project-icon">
										<span class="fa fa-search"></span>
									</div>
...
<div class="col-xs-12 col-md-6 col-lg-4">
						<div class="box-gallery">
							<a href="images/gal14.jpg" title="Gallery #6">
								<img src="images/gal14.jpg" alt="" class="img-fluid">
								<div class="project-info">
									<div class="project-icon">
										<span class="fa fa-search"></span>
									</div>
			...
			<div class="container">
				...
				<div class="row mt-4">
					...
					<div class="col-sm-12 col-md-12 col-lg-4 mb-5">
						<div class="rs-news-1">
							<div class="media-box">
								<img src="images/bottomimg1.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
					...
					<div class="col-sm-12 col-md-12 col-lg-4 mb-5">
						<div class="rs-news-1">
							<div class="media-box">
								<img src="images/bottomimg2.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
					...
					<div class="col-sm-12 col-md-12 col-lg-4 mb-5">
						<div class="rs-news-1">
							<div class="media-box">
								<img src="images/bottomimg3.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
							...
							<div class="item">
								<div class="rs-box-testimony">
									<div class="quote-box">
										...
										<div class="media">
											<img src="images/bottomslider.jpg" alt="" class="rounded-circle">
										</div>
										<p class="quote-name">
	...
	<!-- FOOTER SECTION -->
	<div class="footer" data-background="images/bs.jpg">
		<div class="content-wrap">
			<div class="container">
...
<!-- Mirrored from rometheme.net/html/kids/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 12:13:10 GMT -->
</html>