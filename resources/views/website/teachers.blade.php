...
<!-- Mirrored from rometheme.net/html/kids/teachers.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 12:13:46 GMT -->
	...
	<div class="section banner-page" data-background="images/banner-single.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Teachers</div>
			</div>
			<div class="d-flex justify-content-center bd-highlight mb-3">
			...
			<div class="container">				
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-team-1">
							<div class="media-box"><img src="images/teacher_01.png" alt="" class="img-fluid"></div>
							<div class="body">
								<div class="title">Risma Doel</div>
								<div class="position">English Teacher</div>
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-team-1">
							<div class="media-box"><img src="images/teacher_02.png" alt="" class="img-fluid"></div>
							<div class="body">
								<div class="title">Tengku Doel</div>
								<div class="position">Math Teacher</div>
								<p>Dolor sit amet, dolor gravida, placerat liberolorem ipsum dolor consectetur adipiscing elit, sed do eiusmod.</p>
								<div class="sosmed-icon d-inline-flex mb-5">
									<a href="#" class="fb"><i class="fa fa-facebook"></i></a> 
									<a href="#" class="tw"><i class="fa fa-twitter"></i></a> 
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-team-1">
							<div class="media-box"><img src="images/teacher_03.png" alt="" class="img-fluid"></div>
							<div class="body">
								<div class="title">Stevany Doel</div>
								<div class="position">Music Teacher</div>
								<p>Dolor sit amet, dolor gravida, placerat liberolorem ipsum dolor consectetur adipiscing elit, sed do eiusmod.</p>
								<div class="sosmed-icon d-inline-flex mb-5">
									<a href="#" class="fb"><i class="fa fa-facebook"></i></a> 
									<a href="#" class="tw"><i class="fa fa-twitter"></i></a> 
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-team-1">
							<div class="media-box"><img src="images/teacher_04.png" alt="" class="img-fluid"></div>
							<div class="body">
								<div class="title">Broklyn Doel</div>
								<div class="position">English Teacher</div>
								<p>Dolor sit amet, dolor gravida, placerat liberolorem ipsum dolor consectetur adipiscing elit, sed do eiusmod.</p>
								<div class="sosmed-icon d-inline-flex mb-5">
									<a href="#" class="fb"><i class="fa fa-facebook"></i></a> 
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-team-1">
							<div class="media-box"><img src="images/teacher_05.png" alt="" class="img-fluid"></div>
							<div class="body">
								<div class="title">Debora Doel</div>
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-team-1">
							<div class="media-box"><img src="images/teacher_06.png" alt="" class="img-fluid"></div>
							<div class="body">
								<div class="title">Anna Doel</div>
								<div class="position">Sains Teacher</div>
								<p>Dolor sit amet, dolor gravida, placerat liberolorem ipsum dolor consectetur adipiscing elit, sed do eiusmod.</p>
								<div class="sosmed-icon d-inline-flex mb-5">
									<a href="#" class="fb"><i class="fa fa-facebook"></i></a> 
									<a href="#" class="tw"><i class="fa fa-twitter"></i></a> 
...
<!-- Mirrored from rometheme.net/html/kids/teachers.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 12:14:16 GMT -->
</html>