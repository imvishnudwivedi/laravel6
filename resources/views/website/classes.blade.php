...
<!-- Mirrored from rometheme.net/html/kids/classes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 12:13:44 GMT -->
				...
				<div class="row mt-4">
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-class-box mb-5">
							<div class="media-box">
								<img src="images/classes-1.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-class-box mb-5">
							<div class="media-box">
								<img src="images/classes-2.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
								<div class="class-name">
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-class-box mb-5">
							<div class="media-box">
								<img src="images/classes-3.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
								<div class="class-name">
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-class-box mb-5">
							<div class="media-box">
								<img src="images/classes-4.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
								<div class="class-name">
									<div class="title">Imagination Classes</div>
									<div class="price">$20</div>
								</div>
								<div class="open-class">Open Class : <span>08:00 am - 10:00 am</span></div>
								<p>We provide high quality design at vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores...</p>
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-class-box mb-5">
							<div class="media-box">
								<img src="images/classes-5.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
								<div class="class-name">
									<div class="title">Sains Classes</div>
									<div class="price">$20</div>
								</div>
								<div class="open-class">Open Class : <span>08:00 am - 10:00 am</span></div>
								<p>We provide high quality design at vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores...</p>
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
						<div class="rs-class-box mb-5">
							<div class="media-box">
								<img src="images/classes-6.jpg" alt="" class="img-fluid">
							</div>
							<div class="body-box">
								<div class="class-name">
									<div class="title">Language Classes</div>
									<div class="price">$20</div>
								</div>
								<div class="open-class">Open Class : <span>08:00 am - 10:00 am</span></div>
								<p>We provide high quality design at vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores...</p>
...
<!-- Mirrored from rometheme.net/html/kids/classes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 12:13:46 GMT -->
</html>