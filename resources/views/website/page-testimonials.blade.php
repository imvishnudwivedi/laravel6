...
<!-- Mirrored from rometheme.net/html/kids/page-testimonials.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 12:14:34 GMT -->
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-6 col-lg-6">
						<div class="rs-testimonial-1">
		              		<div class="media">
	              				<img src="images/team-img1.jpg" alt="" class="img-fluid">
	              			</div>
			              	<div class="body">
					...
					<div class="col-sm-12 col-md-6 col-lg-6">
						<div class="rs-testimonial-1">
		              		<div class="media">
	              				<img src="images/team-img2.jpg" alt="" class="img-fluid">
	              			</div>
			              	<div class="body">
			                	<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum has been. Mauris ornare tortor in eleifend blanditullam ut ligula et neque. Nulla interdum dapibus erat nec elementum. </p>
					...
					<div class="col-sm-12 col-md-6 col-lg-6">
						<div class="rs-testimonial-1">
		              		<div class="media">
	              				<img src="images/team-img3.jpg" alt="" class="img-fluid">
	              			</div>
			              	<div class="body">
			                	<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum has been. Mauris ornare tortor in eleifend blanditullam ut ligula et neque. Nulla interdum dapibus erat nec elementum. </p>
					...
					<div class="col-sm-12 col-md-6 col-lg-6">
						<div class="rs-testimonial-1">
		              		<div class="media">
	              				<img src="images/team-img4.jpg" alt="" class="img-fluid">
	              			</div>
			              	<div class="body">
			                	<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum has been. Mauris ornare tortor in eleifend blanditullam ut ligula et neque. Nulla interdum dapibus erat nec elementum. </p>
							...
							<div class="item">
								<div class="rs-box-testimony">
									<div class="quote-box">
										...
										<div class="media">
											<img src="images/team-img1.jpg" alt="" class="rounded-circle">
										</div>
										<p class="quote-name">
							...
							<div class="item">
								<div class="rs-box-testimony">
									<div class="quote-box">
										...
										<div class="media">
											<img src="images/team-img2.jpg" alt="" class="rounded-circle">
										</div>
										<p class="quote-name">
...
<!-- Mirrored from rometheme.net/html/kids/page-testimonials.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 12:14:38 GMT -->
</html>